/****************************************************************************
** Meta object code from reading C++ file 'AppInvoker.hpp'
**
...
#include "../../../src/AppInvoker.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'AppInvoker.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_AppInvoker[] = {
    "AppInvoker\0\0openContacts()\0"
    "onInvocationFinished()\0"
};
...
void AppInvoker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onInvocationFinished(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
